        ...
        for ijson in info:
            ...
            if dd.get('ftype', '').lower() == 'text':
                ...
                for sheet in ijson['s']:
                    ...
                    print 'column  count ', hcount,  len(conside_column)
...
if __name__ == '__main__':
    obj = excel()
    ijson = {"cmd_id":126,"company_id":1053724,"template_id":4,"company_name":"PeaksCLO3,Ltd.","project_id":5,"template_name":"CLO Template","user":"demo", "ss": "ccc"}
    #{"cmd_id":126,"company_id":1604,"template_id":4,"company_name":"Monroe Capital LLC","project_id":5,"template_name":"CLO Template","user":"demo",  "ss":"assets"}
    #{"cmd_id":126,"company_id":1053724,"template_id":4,"company_name":"PeaksCLO3,Ltd.","project_id":5,"template_name":"CLO Template","user":"demo", "PRINT": "Y", "ss":"deal"}
